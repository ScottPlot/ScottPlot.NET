...
public class SampleChangelog
{
    ...
    {
        "A1145681", "ab-tools", "AbeniMatteo", "ademkaya", "adgriff2", "Agorath", "AlexFsmn", "AlgoExecutor",
        "allopatin", "Andreas", "AndXaf", "Angeld10", "anose001", "anprevost", "Antracik", "apaaris", "apkrymov",
        "arthurits", "at2software", "AteCoder", "audun", "BambOoxX", "bclehmann", "benton-anderson", "bernhardbreuss",
        "bftrock", "bhairav-thakkar", "Bhandejiya", "bonzaiferroni", "bradmartin333", "breakwinz", "bukkideme",
        "CalderWhite", "CarloToso", "ccopsey", "cdytoby", "charlescao460", "CharlesMauldin", "chenxuuu", "chhh",
        "ChrisAtVault", "ChrisCC6", "chrisxfire", "ckovamees", "codecrafty", "cpa-level-it", "cstyx", "cxjcqu",
        "damiandixon", "DavidBergstromSWE", "DavidWhataGIT", "ddrrrr", "deiruch", "DevJins", "dhgigisoave", "diluculo",
        "DmitryZhelnin", "dongyi-cai-windsab", "dusko23", "eduhza", "EFeru", "el-aasi", "Elgot", "envine", "FadyDev2",
        "FannyAtGitHub", "fe-c", "Fruchtzwerg94", "fuxinsen", "gauravagrwal", "gberrante", "Gholamalih", "gigios",
        "gobikulandaisamy", "grabul", "Guillaume-Deville", "gwilson9", "hamhub7", "heartacker", "Helitune-RobMcKay",
        "hellfo", "hexxone", "hhubschle", "hibus", "HowardWhile", "Ichibot200", "imka-code", "inqb", "ismdiego",
        "iu2kxv", "JagDTalcyon", "jankri", "jbuckmccready", "jcbeppler", "jhm-ciberman", "jl0pd", "johndoh", "johnfoll",
        "JohniMIEP", "Jonathanio123", "Jordant190", "JS-BGResearch", "JulianusIV", "jw-suh", "Kamran", "KanishkKhurana",
        "karimshams", "KATAMANENI", "KC7465128305", "kegesch", "kirsan31", "kivarsen", "kkaiser41", "KlaskSkovby",
        "KonH", "Kritner", "KroMignon", "ktheijs", "kurupt44", "kv-gits", "LB767", "liuhongran626", "LogDogg",
        "Logicman111", "lucabat", "Luvnet-890", "m4se", "MachineFossil", "Maoyao233", "Marc-Frank", "marcelpel", "MareMare",
        "Margulieuxd", "marklam", "martin-brajer", "martinkleppe", "Matthias-C", "minjjKang", "Minu476", "MisterRedactus",
        "MithrilMan", "mjpz", "mocakturk", "morningkyle", "mrradd", "mYcheng-95", "MyZQL", "mzemljak", "nanrod",
        "nashilnik", "nassaleh", "Nasser", "neilyoung2008", "Neopentane1", "Nextra", "Nexus452", "Niravk1997", "noob765",
